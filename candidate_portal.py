...
<div class="portal-header">
    <p class="nav-brand">🏢 腾讯内部竞聘服务中心</p>
    <p class="nav-sub">Tencent Internal Talent Competition Portal</p>
...
# ══════════════════════════════════════════════════════════════════
with tab1:
    dm.record_visit(st.session_state.sid, "服务中心")
    ...
    st.markdown(f"""
<div class="hero-card">
    <h2 style="color:#001d6c;margin-top:0;">👋 欢迎使用腾讯内部竞聘服务中心</h2>
...
<div class="notice-box">
    ...
    <ul>
        ...
        <li>如遇技术问题，请联系 <strong>hr-ai@tencent.com</strong>（工作日 9:00–18:00）</li>
...
<div class="contact-card">
    ...
    <p style="margin:8px 0 0;font-size:13px;color:#595959;">
        邮箱：<strong>hr-ai@tencent.com</strong> &nbsp;|&nbsp;
...
# ══════════════════════════════════════════════════════════════════
with tab2:
    dm.record_visit(st.session_state.sid, "在线投递")
...
<div style="background:#e6f4ff;border:1px solid #91caff;border-radius:12px;
    ...
    <div style="font-size:13px;color:#0050b3;margin-top:8px;">
        请耐心等待 HR 审核，通常在 <strong>3 个工作日</strong>内完成。如有疑问请联系 hr-ai@tencent.com
    </div>
</div>
""", unsafe_allow_html=True)
    else:
...
腾讯科技（深圳）有限公司将收集您的姓名、员工编号、部门、工龄、评分数据、简历文件及竞聘自述，
...
""")
        ...
        if st.button("📤 提交竞聘申请", type="primary",
            ...
            dm.record_visit(st.session_state.sid, "简历投递")
            st.markdown(f"""
...
# ══════════════════════════════════════════════════════════════════
with tab3:
    dm.record_visit(st.session_state.sid, "查询报告")
...
<div style="background:#fff1f0;border:1px solid #ffa39e;border-radius:10px;
    ...
    <div style="font-size:12px;color:#cf1322;margin-top:4px;">
        请核对员工编号或姓名是否正确，如有疑问请联系 hr-ai@tencent.com
    </div>
</div>
""", unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════════
with tab4:
    dm.record_visit(st.session_state.sid, "提交申诉")
...
<div class="appeal-info-box">
    <div class="appeal-info-title">📋 申诉须知与规则</div>

    <div class="appeal-row">
        <span class="appeal-tag info">受理条件</span>
        <span class="appeal-row-text">仅限竞聘结果公示后 <strong>48 小时内</strong>提交（截止 2025-07-15 18:00）</span>
    </div>
    <div class="appeal-row">
        <span class="appeal-tag valid">有效类型</span>
        <span class="appeal-row-text">
            AI评分偏差 · 绩效数据滞后 · 笔试题目歧义 · 材料未被识别
        </span>
    </div>
    <div class="appeal-row">
        <span class="appeal-tag invalid">无效情形</span>
        <span class="appeal-row-text">
            单纯对结果不满 · 超过申诉窗口期 · 重复申诉同一事项
        </span>
    </div>
    <div class="appeal-row">
        <span class="appeal-tag info">处理时限</span>
        <span class="appeal-row-text">HR 将在 <strong>3 个工作日</strong>内书面回复申诉结果</span>
    </div>
    <div class="appeal-row">
        <span class="appeal-tag info">申诉联系</span>
        <span class="appeal-row-text">hr-ai@tencent.com（工作日 9:00–18:00）</span>
    </div>
</div>
""", unsafe_allow_html=True)
    ...
    if st.button("📩 提交申诉", type="primary",
        ...
        dm.record_visit(st.session_state.sid, "申诉提交")
        st.markdown(f"""
<div class="submit-success">
...
# ══════════════════════════════════════════════════════════════════
with tab5:
    dm.record_visit(st.session_state.sid, "申诉进度")
...
# ══════════════════════════════════════════════════════════════════
with tab6:
    dm.record_visit(st.session_state.sid, "须知与政策")
...
<strong>腾讯科技（深圳）有限公司 · 个人信息收集与使用声明</strong>
<br><br>
<strong>数据控制方：</strong>腾讯科技（深圳）有限公司（以下简称"公司"）
<br><br>
...
<br><br>
<strong>您的权利：</strong>您有权随时查询、更正、删除您的个人信息，或撤回同意授权。如需行使上述权利，请联系 <strong>hr-ai@tencent.com</strong>。
<br><br>
...
<div class="footer-bar">
    <p><strong>腾讯科技（深圳）有限公司</strong> · 人力资源部 · 内部竞聘管理平台</p>
    <p>© 2025 Tencent. All rights reserved. &nbsp;|&nbsp;
       技术支持：<strong>hr-ai@tencent.com</strong> &nbsp;|&nbsp;
