...
RESOURCES = {
    "岗位匹配度": [
        ("某公司内部·PM成长路径手册（必读）",        "https://iwiki.woa.com/p/pm-growth-path"),
        ("某公司课堂·产品经理核心技能训练营（6h）",    "https://ke.qq.com/course/5982909"),
    ...
    "历史绩效": [
        ("某公司内部·OKR设定与绩效复盘方法论",        "https://km.woa.com/articles/show/okr-guide"),
        ("某公司内部·绩效提升工作坊（每季度开放报名）", "https://talent.XXX Company.com/training/performance"),
        ("极客时间·高效工作法与个人效能提升专栏",    "https://time.geekbang.org/column/intro/100018401"),
    ],
    "笔试成绩": [
        ("某公司内部·PM笔试历年题库与详解",           "https://km.woa.com/group/product/exam-prep"),
        ("极客时间·数据分析实战 45 讲",             "https://time.geekbang.org/column/intro/100093501"),
        ("产品经理之家·案例题在线练习库",            "https://www.pmcaff.com/tools/exam"),
        ("某公司数据平台·数据思维与分析入门课",        "https://data.qq.com/article/data-thinking"),
    ],
}
...
def classify_appeal_rules(reason: str) -> dict:
    ...
    resp_map = {
        ...
        "材料未被识别": "您好，已收到您关于材料识别的申诉，请通过邮件重新提交相关材料至 hr-ai@XXX Company.com，将加急处理。",
...
- 主动申请参与产品部门虚拟项目组：[某公司内部·开放项目列表](https://km.woa.com/group/product-open-projects)
- 在现部门承接需求对接角色，用 STAR 格式记录可量化案例（「主导 XX 需求落地，指标提升 X%」）
- 结构化复盘每次跨部门协作经历：[协作复盘记录模板](https://iwiki.woa.com/p/collab-review-template)

#### 第三步：系统认证（第 5–12 周）

- 完成某公司 PM 成长认证：[某公司产品经理认证体系](https://talent.XXX Company.com/certification/pm)（结业证书可附于下次竞聘材料）
- 建立个人 PM 知识框架：[知识地图参考模板](https://iwiki.woa.com/p/pm-knowledge-map)
- 模拟笔试演练（建议竞聘前 4 周完成）：[PM 能力在线模拟考](https://talent.XXX Company.com/mock-test/pm)

#### 下次竞聘 Checklist

- [ ] **{lo[0]}** 提升至 {lo[1]+gap*1.5:.0f} 分以上
- [ ] 积累至少 **2 个**可量化的产品实践案例（STAR 格式）
- [ ] 完成某公司 PM 认证课程并取得结业证明
...
>
> *由某公司 AI 竞聘评审系统生成 · {now} · 咨询请联系 hr-ai@XXX Company.com*"""
                ...
                if st.session_state.client:
                    try:
                        resp = st.session_state.client.messages.create(
                            ...
                            system="你是某公司人才发展顾问，报告温和、专业、激励性强，保留所有链接和数据。",
                            messages=[{"role":"user","content":
